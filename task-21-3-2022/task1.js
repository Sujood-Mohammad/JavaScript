...
return a.slice(middle1 - 1, middle2);
  ...
  console.log(middleItem(arr1));
  console.log(middleItem(arr2));
/*
9
...
*/
var animals = ['cat', 'ele', 'bird'];
animals = ['zebra', 'elephant'];   // or by    animals[0]='zebra' ; animals[1]='elephant' ;
console.log(animals)
var nums= [1,2,3,8,9]; 
nums=[5,-22,3.5,44,98,44];
console.log(nums);
...
*/
var nums= [1,2,3,8,9];
function arrayExceptLast(parameter){
  nums.pop();
  console.log(nums)
}
...
*/
var nums= [1,2,3,8,9];
function removeFromArray(p1,p2){
